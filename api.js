...
app.get('/signupredirect',function(req,res){
...
app.post('/signup',function(req,res){
	...
	connection.query('INSERT INTO user_detail (username,password,name,gender,age,emailid,mobile_no) VALUES (?,?,?,?,?,?,?)',[user,password,name,gender,age,emailid,mobile_no],
...
app.post('/login',function(req,res){
  ...
  Autobio = AutobioContract.at('0x07933b689ffd7ec89e82268475910a5bea8a72dd');
...
app.post('/searchredirect',function(req,res){
	var search_book=req.body.bookname2;
	console.log(search_book);
		connection.query('SELECT bookid,bookname,genre from book_details where bookname=?',[search_book],
		   function(err, results,fields){
		    if(err){
		    	console.log(err);
		    	...
		    	res.send({
			      ...
			      "failed":"error ocurred"
		    				...
		    				console.log(results);
					   		var book_name = JSON.stringify(results);
					  		res.render(__dirname+'/views/searching',{bookname:book_name});
		    }
		});
...
app.post('/filterredirect',function(req,res){
	var filter=req.body.genre;
	//console.log(search_book);
		connection.query('SELECT bookid,bookname,genre from book_details where genre=?',[filter],
		   function(err, results,fields){
		    if(err){
		    	console.log(err);
		    	...
		    	res.send({
			      ...
			      "failed":"error ocurred"
		    				...
		    				console.log(results);
					   		var book_genre = JSON.stringify(results);
					  		res.render(__dirname+'/views/filtering',{genre:book_genre});
		    }
		});
...
app.post('/continue_chapter_addpage',function(req,res){
